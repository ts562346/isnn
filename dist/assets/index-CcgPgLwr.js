...
\r
        ...
        <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700&family=Pacifico&display=swap" rel="stylesheet">\r
\r
        <!-- Icon Font Stylesheet -->\r
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css"/>\r
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">\r
\r
        <!-- Libraries Stylesheet -->\r
        <link href="lib/animate/animate.min.css" rel="stylesheet">\r
        <link href="lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">\r
\r
        <!-- Customized Bootstrap Stylesheet -->\r
        <link href="css/bootstrap.min.css" rel="stylesheet">\r
\r
        <!-- Template Stylesheet -->\r
...
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row g-4 align-items-stretch">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <p class="fs-4 text-dark">WELCOME TO ISNNS Ummah</p>\r
                            <h1 class="display-1 mb-5 text-dark">Purity Comes From Faith.</h1>\r
                            <a href="#" data-donate-popup="true" class="btn btn-primary hero-donate-btn">Donate Now</a>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-5">\r
                        <div class="hero-prayer-card wow fadeIn" data-wow-delay="0.2s">\r
                            <!-- <div class="hero-prayer-icon">\r
                                <i class="fa fa-mosque"></i>\r
                            </div> -->\r
                            <div class="hero-prayer-head row g-0">\r
                                <div class="col-4">Salat</div>\r
                                <div class="col-4 text-center">Start</div>\r
                                <div class="col-4 text-end">Iqamah</div>\r
                            </div>\r
                            <div class="hero-prayer-row row g-0" data-prayer-row="fajr">\r
                                <div class="col-4">Al-Fajr</div>\r
                                <div class="col-4 text-center" data-prayer-start>--:--</div>\r
                                <div class="col-4 text-end" data-prayer-iqama>--:--</div>\r
                            </div>\r
                            <div class="hero-prayer-row row g-0" data-prayer-row="dhuhr">\r
                                <div class="col-4">Al-Zuhr</div>\r
                                <div class="col-4 text-center" data-prayer-start>--:--</div>\r
                                <div class="col-4 text-end" data-prayer-iqama>--:--</div>\r
                            </div>\r
                            <div class="hero-prayer-row row g-0" data-prayer-row="asr">\r
                                <div class="col-4">Al-Asr</div>\r
                                <div class="col-4 text-center" data-prayer-start>--:--</div>\r
                                <div class="col-4 text-end" data-prayer-iqama>--:--</div>\r
                            </div>\r
                            <div class="hero-prayer-row row g-0" data-prayer-row="maghrib">\r
                                <div class="col-4">Al-Magrib</div>\r
                                <div class="col-4 text-center" data-prayer-start>--:--</div>\r
                                <div class="col-4 text-end" data-prayer-iqama>--:--</div>\r
                            </div>\r
                            <div class="hero-prayer-row row g-0" data-prayer-row="isha">\r
                                <div class="col-4">Al-Isha</div>\r
                                <div class="col-4 text-center" data-prayer-start>--:--</div>\r
                                <div class="col-4 text-end" data-prayer-iqama>--:--</div>\r
                            </div>\r
                            <div class="hero-prayer-row row g-0">\r
                                <div class="col-12 text-center small" data-prayer-status>Updating from Mawaqit...</div>\r
                            </div>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
        <!-- About Satrt -->\r
        <div class="container-fluid about py-5">\r
            <div class="container py-5">\r
                <div class="row g-5 mb-5">\r
                    <div class="col-xl-6">\r
                        <div class="row g-4">\r
                            <div class="col-6">\r
                                <img src="img/about-1.jpg" class="img-fluid h-100 wow zoomIn" data-wow-delay="0.1s" alt="">\r
                            </div>\r
                            <div class="col-6">\r
                                <img src="img/about-2.jpg" class="img-fluid pb-3 wow zoomIn" data-wow-delay="0.1s" alt="">\r
                                <img src="img/about-3.jpg" class="img-fluid pt-3 wow zoomIn" data-wow-delay="0.1s" alt="">\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-xl-6 wow fadeIn" data-wow-delay="0.5s">\r
                        <p class="fs-5 text-uppercase text-primary">About ISNNS</p>\r
                        <h1 class="display-5 pb-4 m-0">Islamic Society of Nigerians in Nova Scotia</h1>\r
                        <p class="pb-4">We are Nigerians in Nova Scotia committed to preserving and propagating Islam while nurturing future generations upon authentic Islamic values.</p>\r
                        <div class="row g-4 mb-4">\r
                            <div class="col-md-6">\r
                                <div class="ps-3 d-flex align-items-center justify-content-start">\r
                                    <span class="bg-primary btn-md-square rounded-circle mt-4 me-2"><i class="fa fa-eye text-dark fa-4x mb-5 pb-2"></i></span>\r
                                    <div class="ms-4">\r
                                        <h5>Our Vision</h5>\r
                                        <p>To nurture a united and spiritually grounded Nigerian Muslim community.</p>\r
                                    </div>\r
                                </div>\r
                            </div>\r
                            <div class="col-md-6">\r
                                <div class="ps-3 d-flex align-items-center justify-content-start">\r
                                    <span class="bg-primary btn-md-square rounded-circle mt-4 me-2"><i class="fa fa-flag text-dark fa-4x mb-5 pb-2"></i></span>\r
                                    <div class="ms-4">\r
                                        <h5>Our Mission</h5>\r
                                        <p>To strengthen Islamic learning through lectures, programs, and community engagement.</p>\r
                                    </div>\r
                                </div>\r
                            </div>\r
                        </div>\r
                        <div class="bg-light p-3 mb-4">\r
                            <div class="row align-items-center justify-content-center">\r
                                <div class="col-3">\r
                                    <img src="img/about-child.jpg" class="img-fluid rounded-circle" alt="">\r
                                </div>\r
                                <div class="col-6">\r
                                    <p class="mb-0">Founded through family adhkar gatherings in 2018 and formally registered as a non-profit in 2020.</p>\r
                                </div>\r
                                <div class="col-3">\r
                                        <h2 class="mb-0 text-primary text-center">2018</h2>\r
                                        <h5 class="mb-0 text-center">Since</h5>\r
                                </div>\r
                            </div>\r
                        </div>\r
                        <div class="row g-2">\r
                            <div class="col-md-6">\r
                                <p class="mb-2"><i class="fa fa-check text-primary me-3"></i>Monthly Adhkar Gathering</p>\r
                                <p class="mb-0"><i class="fa fa-check text-primary me-3"></i>Ramadan Lectures & Iftar</p>\r
                            </div>\r
                            <div class="col-md-6">\r
                                <p class="mb-2"><i class="fa fa-check text-primary me-3"></i>Support for Students</p>\r
                                <p class="mb-0"><i class="fa fa-check text-primary me-3"></i>Eid al-Adha Celebration</p>\r
                            </div>\r
                        </div>\r
                    </div>\r
                </div>\r
                <div class="container text-center bg-primary py-5 wow fadeIn" data-wow-delay="0.1s">\r
                    <div class="row g-4 align-items-center">\r
                        <div class="col-lg-2">\r
                            <i class="fa fa-mosque fa-5x text-white"></i>\r
                        </div>\r
                        <div class="col-lg-7 text-center text-lg-start">\r
                            <h1 class="mb-0">Every Muslim Needs To Realise The Importance Of The "Pillar" Of Islam</h1>\r
                        </div>\r
                        <div class="col-lg-3">\r
                            <a href="" class="btn btn-light py-2 px-4">Learn More</a>\r
                        </div>\r
                    </div>\r
                </div>\r
            </div>\r
...
\r
        <!-- Activities Start -->\r
        <div class="container-fluid activities py-5">\r
            <div class="container py-5">\r
                <div class="mx-auto text-center mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">\r
                    <p class="fs-5 text-uppercase text-primary">Activities</p>\r
                    <h1 class="display-3">Here Are Our Activities</h1>\r
                </div>\r
                <div class="row g-4">\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.1s">\r
                            <i class="fa fa-mosque fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Adhkar Gathering</h4>\r
                                <p class="mb-4">Held on the first Sunday of every month at CID Mosque with Zoom access for members.</p>\r
                                <a href="/activity#azkar-gathering" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.3s">\r
                            <i class="fa fa-donate fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Ramadan Iftar</h4>\r
                                <p class="mb-4">A community potluck iftar with Islamic reminders to enrich Ramadan worship.</p>\r
                                <a href="/activity#ramadan-iftar" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.5s">\r
                            <i class="fa fa-quran fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Ramadan Lectures</h4>\r
                                <p class="mb-4">Weekly Ramadan lectures covering practical Islamic topics for daily life.</p>\r
                                <a href="/activity#ramadan-lectures" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.1s">\r
                            <i class="fa fa-book fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Student Support</h4>\r
                                <p class="mb-4">Food packages for Nigerian international Muslim students in Nova Scotia during Ramadan.</p>\r
                                <a href="/activity#student-assistance-ramadan" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.3s">\r
                            <i class="fa fa-book-open fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Women Wing</h4>\r
                                <p class="mb-4">Programs designed to strengthen sisterhood, faith, and Islamic family life.</p>\r
                                <a href="/woman" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.5s">\r
                            <i class="fa fa-hands fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Youth Wing</h4>\r
                                <p class="mb-4">Youth-focused engagement to build Islamic identity, confidence, and good character.</p>\r
                                <a href="/youth" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
        <!-- Events Start -->\r
        <div class="container-fluid event py-5">\r
            <div class="container py-5">\r
                <h1 class="display-3 mb-5 wow fadeIn" data-wow-delay="0.1s">Upcoming <span class="text-primary">Events</span></h1>\r
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.1s">\r
                    <div class="col-3 col-lg-2 pe-0">\r
                        <div class="text-center border-bottom border-dark py-3 px-2">\r
                            <h6>1st Sunday Monthly</h6>\r
                            <p class="mb-0">In-person + Zoom</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-9 col-lg-6 border-start border-dark pb-5">\r
                        <div class="ms-3">\r
                            <h4 class="mb-3">Adhkar Gathering (Asalatu)</h4>\r
                            <p class="mb-4">Regular remembrance, supplication, and Islamic reminders organized for members and families.</p>\r
                            <a href="event.html" class="btn btn-primary px-3">Learn More</a>\r
                        </div>\r
                    </div>\r
                    <div class="col-12 col-lg-4">\r
                        <div class="overflow-hidden mb-5">\r
                            <img src="img/events-1.jpg" class="img-fluid w-100" alt="">\r
                        </div>\r
                    </div>\r
                </div>\r
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.3s">\r
                    <div class="col-3 col-lg-2 pe-0">\r
                        <div class="text-center border-bottom border-dark py-3 px-2">\r
                            <h6>Ramadan</h6>\r
                            <p class="mb-0">Community Program</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-9 col-lg-6 border-start border-dark pb-5">\r
                        <div class="ms-3">\r
                            <h4 class="mb-3">Ramadan Iftar & Lectures</h4>\r
                            <p class="mb-4">Collective iftar and weekly lectures that support spiritual growth throughout Ramadan.</p>\r
                            <a href="event.html" class="btn btn-primary px-3">Learn More</a>\r
                        </div>\r
                    </div>\r
                    <div class="col-12 col-lg-4">\r
                        <div class="overflow-hidden mb-5">\r
                            <img src="img/events-2.jpg" class="img-fluid w-100" alt="">\r
                        </div>\r
                    </div>\r
                </div>\r
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.5s">\r
                    <div class="col-3 col-lg-2 pe-0">\r
                        <div class="text-center border-bottom border-dark py-3 px-2">\r
                            <h6>Annual</h6>\r
                            <p class="mb-0">Eid Program</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-9 col-lg-6 border-start border-dark pb-5">\r
                        <div class="ms-3">\r
                            <h4 class="mb-3">Eid al-Adha Celebration</h4>\r
                            <p class="mb-4">A joyful annual gathering featuring Islamic talks and educational activities for all ages.</p>\r
                            <a href="event.html" class="btn btn-primary px-3">Learn More</a>\r
                        </div>\r
                    </div>\r
                    <div class="col-12 col-lg-4">\r
                        <div class="overflow-hidden mb-5">\r
                            <img src="img/events-3.jpg" class="img-fluid w-100" alt="">\r
                        </div>\r
                    </div>\r
                </div>\r
            </div>\r
        ...
        <!-- Events End -->\r
\r
        <!-- Mosques and Schools Start -->\r
        <div class="container-fluid py-5">\r
            <div class="container py-5">\r
                <div class="row g-5">\r
                    <div class="col-lg-8 wow fadeIn" data-wow-delay="0.1s">\r
                        <p class="fs-5 text-uppercase text-primary">Mosques in NS</p>\r
                        <h1 class="display-5 mb-4">List of Mosques in Nova Scotia</h1>\r
                        <div class="row g-4">\r
                            <div class="col-md-6">\r
                                <div class="border rounded p-4 h-100 bg-light">\r
                                    <h5 class="mb-2">Ummah Masjid</h5>\r
                                    <p class="mb-2"><strong>Address:</strong> To be added</p>\r
                                    <a class="mosque-link" href="https://www.ummahmasjid.ca/" target="_blank" rel="noopener noreferrer">https://www.ummahmasjid.ca/</a>\r
                                </div>\r
                            </div>\r
                            <div class="col-md-6">\r
                                <div class="border rounded p-4 h-100 bg-light">\r
                                    <h5 class="mb-2">Centre for Islamic Development (CID)</h5>\r
                                    <p class="mb-2"><strong>Address:</strong> To be added</p>\r
                                    <a class="mosque-link" href="https://www.cidonline.ca/" target="_blank" rel="noopener noreferrer">https://www.cidonline.ca/</a>\r
                                </div>\r
                            </div>\r
                            <div class="col-md-6">\r
                                <div class="border rounded p-4 h-100 bg-light">\r
                                    <h5 class="mb-2">Albarka</h5>\r
                                    <p class="mb-2"><strong>Address:</strong> To be added</p>\r
                                    <a class="mosque-link" href="https://unitedmuslimsofhalifax.ca/" target="_blank" rel="noopener noreferrer">https://unitedmuslimsofhalifax.ca/</a>\r
                                </div>\r
                            </div>\r
                            <div class="col-md-6">\r
                                <div class="border rounded p-4 h-100 bg-light">\r
                                    <h5 class="mb-2">NISCC (Kearney Lake)</h5>\r
                                    <p class="mb-2"><strong>Address:</strong> To be added</p>\r
                                    <a class="mosque-link" href="https://nsicc.ca/" target="_blank" rel="noopener noreferrer">https://nsicc.ca/</a>\r
                                </div>\r
                            </div>\r
                            <div class="col-12">\r
                                <div class="border rounded p-4 h-100 bg-light">\r
                                    <h5 class="mb-2">Sabeel Mosque and IANS (Dartmouth)</h5>\r
                                    <p class="mb-2"><strong>Address:</strong> To be added</p>\r
                                    <a class="mosque-link" href="https://sabeelcenter.ca/" target="_blank" rel="noopener noreferrer">https://sabeelcenter.ca/</a>\r
                                </div>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s">\r
                        <div class="border rounded p-4 h-100">\r
                            <p class="fs-5 text-uppercase text-primary mb-2">Islamic Schools in NS</p>\r
                            <h2 class="h4 mb-4">Schools</h2>\r
                            <ul class="list-unstyled mb-0">\r
                                <li class="mb-3"><i class="fa fa-check text-primary me-2"></i>Ihsan Academy</li>\r
                                <li><i class="fa fa-check text-primary me-2"></i>Maritime Academy</li>\r
                            </ul>\r
                        </div>\r
                    </div>\r
                </div>\r
        ...
        <!-- Mosques and Schools End -->\r
\r
\r
        <!-- Sermon Start -->\r
        <!-- <div class="container-fluid sermon py-5">\r
            <div class="container py-5">\r
                <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">\r
                    <p class="fs-5 text-uppercase text-primary">Sermons</p>\r
                    <h1 class="display-3">Join The Islamic Community</h1>\r
                </div>\r
                <div class="row g-4 justify-content-center">\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="sermon-item wow fadeIn" data-wow-delay="0.1s">\r
                            <div class="overflow-hidden p-4 pb-0">\r
                                <img src="img/sermon-1.jpg" class="img-fluid w-100" alt="">\r
                            </div>\r
                            <div class="p-4">\r
                                <div class="sermon-meta d-flex justify-content-between pb-2">\r
                                    <div class="">\r
                                        <small><i class="fa fa-calendar me-2 text-muted"></i><a href="" class="text-muted me-2">13 Nov 2023</small></a>\r
                                        <small><i class="fas fa-user me-2 text-muted"></i><a href="" class="text-muted">Admin</small></a>\r
                                    </div>\r
                                    <div class="">\r
                                        <a href="" class="me-1"><i class="fas fa-video text-muted"></i></a>\r
                                        <a href="" class="me-1"><i class="fas fa-headphones text-muted"></i></a>\r
                                        <a href="" class="me-1"><i class="fas fa-file-alt text-muted"></i></a>\r
                                        <a href="" class=""><i class="fas fa-image text-muted"></i></a>\r
                                    </div>\r
                                </div>\r
                                <a href="" class="d-inline-block h4 lh-sm mb-3">How to get closer to Allah</a>\r
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, \r
                                aliquip ex ea commodo consequat.</p>\r
                            </div>\r
                        </div>\r
                    </div>\r
                   <div class="col-lg-6 col-xl-4">\r
                        <div class="sermon-item wow fadeIn" data-wow-delay="0.3s">\r
                            <div class="overflow-hidden p-4 pb-0">\r
                                <img src="img/sermon-2.jpg" class="img-fluid w-100" alt="">\r
                            </div>\r
                            <div class="p-4">\r
                                <div class="sermon-meta d-flex justify-content-between pb-2">\r
                                    <div class="">\r
                                ...
                                <a href="" class="d-inline-block h4 lh-sm mb-3">Importance of Hajj in Islam</a>\r
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, \r
                                aliquip ex ea commodo consequat.</p>\r
                            </div>\r
                        </div>\r
                   ...
                   <div class="col-lg-6 col-xl-4">\r
                        <div class="sermon-item wow fadeIn" data-wow-delay="0.5s">\r
                            <div class="overflow-hidden p-4 pb-0">\r
                                <img src="img/sermon-3.jpg" class="img-fluid w-100" alt="">\r
                            </div>\r
                            <div class="p-4">\r
                                <div class="sermon-meta d-flex justify-content-between pb-2">\r
                                    <div class="">\r
                                ...
                                <a href="" class="d-inline-block h4 lh-sm mb-3">Importance of “Piller” of Islam</a>\r
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, \r
                                aliquip ex ea commodo consequat.</p>\r
                            </div>\r
                        </div>\r
...
\r
        ...
        <!-- <div class="container-fluid py-5">\r
            <div class="container py-5">\r
                <h1 class="display-3 mb-5 wow fadeIn" data-wow-delay="0.1s">Latest From <span class="text-primary">Our Blog</span></h1>\r
                <div class="row g-4 justify-content-center">\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="blog-item wow fadeIn" data-wow-delay="0.1s">\r
                            <div class="blog-img position-relative overflow-hidden">\r
                                <img src="img/blog-1.jpg" class="img-fluid w-100" alt="">\r
                                <div class="bg-primary d-inline px-3 py-2 text-center text-white position-absolute top-0 end-0">01 Jan 2045</div>\r
                            </div>\r
                            <div class="p-4">\r
                                <div class="blog-meta d-flex justify-content-between pb-2">\r
                                    <div class="">\r
                                        <small><i class="fas fa-user me-2 text-muted"></i><a href="" class="text-muted me-2">By Admin</small></a>\r
                                        <small><i class="fa fa-comment-alt me-2 text-muted"></i><a href="" class="text-muted me-2">12 Comments</small></a>\r
                                    </div>\r
                                    <div class="">\r
                                        <a href=""><i class="fas fa-bookmark text-muted"></i></a>\r
                                    </div>\r
                                </div>\r
                                <a href="" class="d-inline-block h4 lh-sm mb-3">Importance of “Piller” of Islam</a>\r
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, \r
                                aliquip ex ea commodo consequat.</p>\r
                                <a href="#" class="btn btn-primary px-3">More Details</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="blog-item wow fadeIn" data-wow-delay="0.3s">\r
                            <div class="blog-img position-relative overflow-hidden">\r
                                <img src="img/blog-2.jpg" class="img-fluid w-100" alt="">\r
                                <div class="bg-primary d-inline px-3 py-2 text-center text-white position-absolute top-0 end-0">01 Jan 2045</div>\r
                            </div>\r
                            <div class="p-4">\r
                                <div class="blog-meta d-flex justify-content-between pb-2">\r
                   ...
                   <div class="col-lg-6 col-xl-4">\r
                        <div class="blog-item wow fadeIn" data-wow-delay="0.5s">\r
                            <div class="blog-img position-relative overflow-hidden">\r
                                <img src="img/blog-3.jpg" class="img-fluid w-100" alt="">\r
                                <div class="bg-primary d-inline px-3 py-2 text-center text-white position-absolute top-0 end-0">01 Jan 2045</div>\r
                            </div>\r
                            <div class="p-4">\r
                                <div class="blog-meta d-flex justify-content-between pb-2">\r
...
\r
        <!-- Team Start -->\r
        <!-- <div class="container-fluid team py-5">\r
            <div class="container py-5">\r
                <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">\r
                    <p class="fs-5 text-uppercase text-primary">Our Team</p>\r
                    <h1 class="display-3">Meet Our Organizer</h1>\r
                </div>\r
                <div class="row g-5">\r
                    <div class="col-lg-4 col-xl-5">\r
                        <div class="team-img wow zoomIn" data-wow-delay="0.1s">\r
                            <img src="img/team-1.jpg" class="img-fluid" alt="">\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-8 col-xl-7">\r
                        <div class="team-item wow fadeIn" data-wow-delay="0.1s">\r
                            <h1>Anamul Hasan</h1>\r
                            <h5 class="fw-normal fst-italic text-primary mb-4">President</h5>\r
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, \r
                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. aliquip ex ea commodo consequat.</p>\r
                            <div class="team-icon d-flex pb-4 mb-4 border-bottom border-primary">\r
                                <a class="btn btn-primary btn-lg-square me-2" href=""><i class="fab fa-facebook-f"></i></a>\r
                                <a class="btn btn-primary btn-lg-square me-2" href=""><i class="fab fa-twitter"></i></a>\r
                                <a href="#" class="btn btn-primary btn-lg-square me-2"><i class="fab fa-instagram"></i></a>\r
                                <a href="#" class="btn btn-primary btn-lg-square"><i class="fab fa-linkedin-in"></i></a>\r
                            </div>\r
                        </div>\r
                        <div class="row g-4">\r
                            <div class="col-md-4">\r
                                <div class="team-item wow zoomIn" data-wow-delay="0.2s">\r
                                    <img src="img/team-2.jpg" class="img-fluid w-100" alt="">\r
                                    <div class="team-content text-dark text-center py-3">\r
                                        <div class="team-content-inner">\r
                                            <h5 class="mb-0">Mustafa Kamal</h5>\r
                                            <p class="text-dark">Imam</p>\r
                                            <div class="team-icon d-flex align-items-center justify-content-center">\r
                                                <a class="btn btn-primary btn-sm-square me-2" href=""><i class="fab fa-facebook-f"></i></a>\r
                                                <a class="btn btn-primary btn-sm-square me-2" href=""><i class="fab fa-twitter"></i></a>\r
                                                <a href="#" class="btn btn-primary btn-sm-square me-2"><i class="fab fa-instagram"></i></a>\r
                                                <a href="#" class="btn btn-primary btn-sm-square"><i class="fab fa-linkedin-in"></i></a>\r
                                            </div>\r
                                        </div>\r
                                    </div>\r
                                </div>\r
                            ...
                            <div class="col-md-4">\r
                                <div class="team-item wow zoomIn" data-wow-delay="0.4s">\r
                                    <img src="img/team-3.jpg" class="img-fluid w-100" alt="">\r
                                    <div class="team-content text-dark text-center py-3">\r
                                        <div class="team-content-inner">\r
                                            <h5 class="mb-0">Nahiyan Momen</h5>\r
                                            <p class="text-dark">Teacher</p>\r
                                            <div class="team-icon d-flex align-items-center justify-content-center">\r
                                                <a class="btn btn-primary btn-sm-square me-2" href=""><i class="fab fa-facebook-f"></i></a>\r
                                                <a class="btn btn-primary btn-sm-square me-2" href=""><i class="fab fa-twitter"></i></a>\r
                                                <a href="#" class="btn btn-primary btn-sm-square me-2"><i class="fab fa-instagram"></i></a>\r
                            ...
                            <div class="col-md-4">\r
                                <div class="team-item wow zoomIn" data-wow-delay="0.6s">\r
                                    <img src="img/team-4.jpg" class="img-fluid w-100" alt="">\r
                                    <div class="team-content text-dark text-center py-3">\r
                                        <div class="team-content-inner">\r
                                            <h5 class="mb-0">Asfaque Ali</h5>\r
                                            <p class="text-dark">Volunteer</p>\r
                                            <div class="team-icon d-flex align-items-center justify-content-center">\r
                                                <a class="btn btn-primary btn-sm-square me-2" href=""><i class="fab fa-facebook-f"></i></a>\r
                                                <a class="btn btn-primary btn-sm-square me-2" href=""><i class="fab fa-twitter"></i></a>\r
                                                <a href="#" class="btn btn-primary btn-sm-square me-2"><i class="fab fa-instagram"></i></a>\r
...
\r
        <!-- Testiminial Start -->\r
        <!-- <div class="container-fluid testimonial py-5">\r
            <div class="container py-5">\r
                <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">\r
                    <p class="fs-5 text-uppercase text-primary">Testimonial</p>\r
                    <h1 class="display-3">What People Say About Islam</h1>\r
                </div>\r
                <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">\r
                    <div class="testimonial-item">\r
                        <div class="d-flex mb-3">\r
                            <div class="position-relative">\r
                                <img src="img/testimonial-1.jpg" class="img-fluid" alt="">\r
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">\r
                                    <i class="fa fa-quote-left text-dark"></i>\r
                                </div>\r
                            </div>\r
                            <div class="ps-3 my-auto ">\r
                                <h5 class="mb-0">Full Name</h5>\r
                                <p class="m-0">Profession</p>\r
                            </div>\r
                        </div>\r
                        <div class="testimonial-content">\r
                            <div class="d-flex">\r
                                <i class="fas fa-star text-primary"></i>\r
                                <i class="fas fa-star text-primary"></i>\r
                                <i class="fas fa-star text-primary"></i>\r
                                <i class="fas fa-star text-primary"></i>\r
                                <i class="fas fa-star text-primary"></i>\r
                            </div>\r
                            <p class="fs-5 m-0 pt-3">Lorem ipsum dolor sit amet elit, sed do tempor ut labore et dolore magna aliqua. Ut enim ad minim quis.</p>\r
                        </div>\r
                    </div>\r
                    <div class="testimonial-item">\r
                        <div class="d-flex mb-3">\r
                            <div class="position-relative">\r
                                <img src="img/testimonial-2.jpg" class="img-fluid" alt="">\r
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">\r
                                    <i class="fa fa-quote-left text-dark"></i>\r
                                </div>\r
                            </div>\r
                    ...
                    <div class="testimonial-item">\r
                        <div class="d-flex mb-3">\r
                            <div class="position-relative">\r
                                <img src="img/testimonial-3.jpg" class="img-fluid" alt="">\r
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">\r
                                    <i class="fa fa-quote-left text-dark"></i>\r
                                </div>\r
                            </div>\r
                    ...
                    <div class="testimonial-item">\r
                        <div class="d-flex mb-3">\r
                            <div class="position-relative">\r
                                <img src="img/testimonial-4.jpg" class="img-fluid" alt="">\r
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">\r
                                    <i class="fa fa-quote-left text-dark"></i>\r
                                </div>\r
                            </div>\r
...
\r
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"><\/script>\r
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"><\/script>\r
        <script src="lib/wow/wow.min.js"><\/script>\r
        <script src="lib/easing/easing.min.js"><\/script>\r
        <script src="lib/waypoints/waypoints.min.js"><\/script>\r
        <script src="lib/owlcarousel/owl.carousel.min.js"><\/script>\r
\r
        <!-- Template Javascript -->\r
        <script src="js/main.js"><\/script>\r
    </body>\r
\r
</html>\r
`,keyName:`index`},{path:`/about`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <!-- Spinner Start -->\r
        <div id="spinner" class="show w-100 vh-100 bg-white position-fixed translate-middle top-50 start-50  d-flex align-items-center justify-content-center">\r
            <div class="spinner-grow text-primary" role="status"></div>\r
        </div>\r
        <!-- Spinner End -->\r
\r
\r
        <script>\r
            window.location.replace("/about" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">About Us</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">About</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
        ...
        <div class="container-fluid about py-5">\r
            <div class="container py-5">\r
                <div class="row g-5 align-items-center mb-5">\r
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">\r
                        <p class="fs-5 text-uppercase text-primary mb-2">About Us</p>\r
                        <h1 class="display-5 mb-4" id="about-us">A Faith-Centered Nigerian Muslim Community in Nova Scotia</h1>\r
                        <p class="mb-4">We are Nigerians residing in Nova Scotia who share a profound love for Islam and a strong sense of responsibility toward its preservation and propagation. United by faith and a common heritage, we are committed to upholding the teachings of Islam in our daily lives while fostering a supportive and spiritually enriching community for our members.</p>\r
                        <div class="bg-light border-start border-4 border-primary p-4 rounded">\r
                            <p class="mb-0">Our collective aim is to strengthen our own understanding and practice of Islam and to actively transmit its values, principles, and teachings to the next generation through consistent learning, unity, and service.</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 wow zoomIn" data-wow-delay="0.2s">\r
                        <div class="row g-3">\r
                            <div class="col-6">\r
                                <img src="img/about-1.jpg" class="img-fluid rounded w-100 h-100" alt="">\r
                            </div>\r
                            <div class="col-6">\r
                                <img src="img/about-2.jpg" class="img-fluid rounded w-100 mb-3" alt="">\r
                                <img src="img/about-3.jpg" class="img-fluid rounded w-100" alt="">\r
                            </div>\r
                        </div>\r
                    </div>\r
                </div>\r
\r
                <div class="row g-4 mb-5">\r
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">\r
                        <div class="bg-light p-4 h-100 rounded">\r
                            <h2 class="h4 mb-3" id="who-we-are"><i class="fa fa-users text-primary me-2"></i>Who we are</h2>\r
                            <p>Our community is dedicated to nurturing an environment where our children and future generations can grow with a firm foundation in the Qur&rsquo;an and Sunnah, embodying sound character and a strong Islamic identity.</p>\r
                            <p class="mb-0">Through continuous learning, community engagement, and the organization of Islamic programs and activities, we strive to foster a supportive and spiritually enriching environment for all members.</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">\r
                        <div class="bg-light p-4 h-100 rounded">\r
                            <h2 class="h4 mb-3" id="how-we-started"><i class="fa fa-history text-primary me-2"></i>How we started</h2>\r
                            <p>In 2018, a small group of families began regular gatherings of remembrance (adhkar), supplication, and encouragement upon righteousness and piety with sincerity for the sake of Allah (SWT).</p>\r
                            <p>By the grace of Allah, the circle expanded and became a platform for unity, learning, and spiritual upliftment for families across Nova Scotia.</p>\r
                            <p class="mb-0">In November 2020, the group was formally registered as a non-profit organization, enabling more structured programs, outreach, and educational initiatives.</p>\r
                        </div>\r
                    </div>\r
                            </div>\r
\r
                <div class="row g-4">\r
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">\r
                        <div class="p-4 border rounded h-100">\r
                            <h2 class="h4 mb-3 text-primary" id="our-vision">Our Vision</h2>\r
                            <p class="mb-0">To nurture a united and spiritually grounded Nigerian Muslim community in Nova Scotia, devoted to the teachings of Islam, exemplifying righteousness, and raising future generations firmly rooted in authentic Islamic values and knowledge.</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">\r
                        <div class="p-4 border rounded h-100">\r
                            <h2 class="h4 mb-3 text-primary" id="our-mission">Our Mission</h2>\r
                            <p class="mb-0">To promote the understanding and practice of Islam among members through regular Islamic lectures, educational programs, and community engagement, fostering spiritual growth, unity, and moral excellence. We strive to equip our children and future generations with sound Islamic knowledge and character, guided by the Qur&rsquo;an and Sunnah, so they may live as confident and responsible Muslims in society.</p>\r
                        </div>\r
                    </div>\r
                </div>\r
            </div>\r
...
\r
        <!-- Back to Top -->\r
        <a href="#" class="btn btn-primary border-3 border-light back-to-top"><i class="fa fa-arrow-up"></i></a>   \r
        \r
        <!-- JavaScript Libraries -->\r
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"><\/script>\r
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"><\/script>\r
...
`,keyName:`about`},{path:`/activity`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/activity" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Events & Programs</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Events & Programs</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
        <div class="container-fluid py-5">\r
            <div class="container py-5">\r
                <!-- <div class="mx-auto text-center mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 900px;">\r
                    <p class="fs-5 text-uppercase text-primary">Events & Programs</p>\r
                    <h1 class="display-5">Our Community Programs</h1>\r
                </div> -->\r
\r
                <section id="azkar-gathering" class="mb-5 wow fadeIn" data-wow-delay="0.1s">\r
                    <h3 class="text-primary mb-3">Azkar Gathering</h3>\r
                    <p>We organize Adhkar gatherings on a regular basis, scheduled for the first Sunday of every month. These spiritually enriching sessions provide members with the opportunity to come together in remembrance of Allah, engage in supplications, and strengthen their faith within a supportive community environment.</p>\r
                    <p>The gatherings are held in person at the Centre for Islamic Development Mosque, offering a conducive atmosphere for collective worship and reflection. In addition, provisions are made for members who are unable to attend physically to participate virtually via Zoom, ensuring inclusivity and broader engagement.</p>\r
                    <p>Through these consistent monthly programs, the Society aims to foster unity, spiritual growth, and a deeper connection to Islamic practices among its members.</p>\r
                    <div class="row g-4 mt-1">\r
                        <div class="col-lg-6">\r
                            <div class="border rounded p-4 h-100 bg-light">\r
                                <h5 class="mb-3"><i class="fa fa-video text-primary me-2"></i>Zoom Meeting Details</h5>\r
                                <p class="mb-2"><strong>Topic:</strong> Monthly Azkar Gathering</p>\r
                                <p class="mb-2"><strong>Day/Time:</strong> First Sunday monthly (time to be added)</p>\r
                                <p class="mb-2"><strong>Meeting ID:</strong> <span data-azkar-zoom-id>To be added</span></p>\r
                                <p class="mb-2"><strong>Passcode:</strong> <span data-azkar-zoom-passcode>To be added</span></p>\r
                                <p class="mb-3"><strong>Zoom Link:</strong> <span data-azkar-zoom-url>To be added</span></p>\r
                                <a href="#" class="btn btn-primary btn-sm" data-azkar-zoom-link>Join on Zoom</a>\r
                            </div>\r
                        </div>\r
                        <div class="col-lg-6">\r
                            <div class="border rounded p-4 h-100">\r
                                <h5 class="mb-3"><i class="fa fa-photo-video text-primary me-2"></i>Asalatu Media</h5>\r
                                <p class="mb-0">This section can display pictures or video highlights from previous Asalatu gatherings when available.</p>\r
                            </div>\r
                        </div>\r
                    </div>\r
                </section>\r
\r
                <section id="ramadan-lectures" class="mb-5 wow fadeIn" data-wow-delay="0.1s">\r
                    <h3 class="text-primary mb-3">Ramadan Lectures</h3>\r
                    <p class="mb-4">Lectures held in Ramadan with dates, lecturers, and pre-recorded lecture links.</p>\r
                    <div class="row g-4">\r
                        <div class="col-md-6 col-xl-4">\r
                            <div class="border rounded p-4 h-100 bg-light">\r
                                <h5 class="mb-2">Lecture Title 1</h5>\r
                                <p class="mb-1"><strong>Date:</strong> <span data-lecture-date>To be added</span></p>\r
                                <p class="mb-1"><strong>Lecturer:</strong> <span data-lecture-speaker>To be added</span></p>\r
                                <p class="mb-3"><strong>Pre-recorded link:</strong> <span data-lecture-url>To be added</span></p>\r
                                <a href="#" class="btn btn-primary btn-sm" data-lecture-link>Watch Pre-recorded Lecture</a>\r
                            </div>\r
                        </div>\r
                        <div class="col-md-6 col-xl-4">\r
                            <div class="border rounded p-4 h-100 bg-light">\r
                                <h5 class="mb-2">Lecture Title 2</h5>\r
                                <p class="mb-1"><strong>Date:</strong> <span data-lecture-date>To be added</span></p>\r
                                <p class="mb-1"><strong>Lecturer:</strong> <span data-lecture-speaker>To be added</span></p>\r
                                <p class="mb-3"><strong>Pre-recorded link:</strong> <span data-lecture-url>To be added</span></p>\r
                                <a href="#" class="btn btn-primary btn-sm" data-lecture-link>Watch Pre-recorded Lecture</a>\r
                        ...
                        <div class="col-md-6 col-xl-4">\r
                            <div class="border rounded p-4 h-100 bg-light">\r
                                <h5 class="mb-2">Lecture Title 3</h5>\r
                                <p class="mb-1"><strong>Date:</strong> <span data-lecture-date>To be added</span></p>\r
                                <p class="mb-1"><strong>Lecturer:</strong> <span data-lecture-speaker>To be added</span></p>\r
                                <p class="mb-3"><strong>Pre-recorded link:</strong> <span data-lecture-url>To be added</span></p>\r
                                <a href="#" class="btn btn-primary btn-sm" data-lecture-link>Watch Pre-recorded Lecture</a>\r
...
\r
                ...
                <div class="row g-4">\r
                    <div class="col-lg-6 col-xl-4">\r
                        <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.1s">\r
                            <i class="fa fa-mosque fa-4x text-dark"></i>\r
                            <div class="ms-4">\r
                                <h4>Mosque Development</h4>\r
                                <p class="mb-4">Lorem ipsum dolor sit amet elit. Donec tempus eros vel dolor mattis aliquam.</p>\r
                                <a href="" class="btn btn-primary px-3">Read More</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-lg-6 col-xl-4">\r
        ...
        <!-- Activities Start -->\r
\r
                <section id="ramadan-iftar" class="mb-5 wow fadeIn" data-wow-delay="0.1s">\r
                    <h3 class="text-primary mb-3">Ramadan Iftar</h3>\r
                    <p>The Society organizes a collective iftar during Ramadan, at which all members are encouraged to attend. The gathering is typically conducted as a potluck, complemented by Islamic lectures that enrich the spiritual experience of participants.</p>\r
                    <p class="mb-0">The event has consistently been engaging and rewarding. Members are advised to look out for the next scheduled iftar during the upcoming Ramadan, with further details to be provided on the &ldquo;Upcoming Events&rdquo; page.</p>\r
                </section>\r
\r
                <section id="student-assistance-ramadan" class="mb-5 wow fadeIn" data-wow-delay="0.1s">\r
                    <h3 class="text-primary mb-3">Assistance to Nigerian International Students in Nova Scotia during Ramadan</h3>\r
                    <p>The Society provides support to Nigerian international Muslim students during the month of Ramadan by offering packages of essential food items to those who express interest.</p>\r
                    <p class="mb-0">During this time, eligible students are encouraged to register their interest, after which arrangements will be made to contact them and deliver the packages during Ramadan. Photographs of previously distributed food items may be included here for reference.</p>\r
                </section>\r
\r
                <section id="eid-il-adha-celebration" class="mb-0 wow fadeIn" data-wow-delay="0.1s">\r
                    <h3 class="text-primary mb-3">Eid-Il-Adha Celebration</h3>\r
                    <p>The Society organizes annual Eid al-Adha celebrations for its members. During this occasion, members come together in unity and joy to commemorate the festival.</p>\r
                    <p class="mb-0">The program includes the sharing of beneficial knowledge, interactive and educational activities&mdash;such as Islamic and Qur&rsquo;anic quizzes conducted through Kahoot&mdash;and the delivery of insightful Islamic sermons to further enrich the spiritual experience of attendees. We can include event pictures here as well.</p>\r
                </section>\r
            </div>\r
        </div>\r
\r
            ...
            <div class="container py-5">\r
                ...
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.1s">\r
                    <div class="col-3 col-lg-2 pe-0">\r
                        <div class="text-center border-bottom border-dark py-3 px-2">\r
                            <h6>01 Jan 2045</h6>\r
                            <p class="mb-0">Fri 06:55</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-9 col-lg-6 border-start border-dark pb-5">\r
                        <div class="ms-3">\r
                            <h4 class="mb-3">Milad Un Nabi</h4>\r
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut \r
                                aliquip ex ea commodo consequat. Duis aute irure dolor in </p>\r
                            <a href="#" class="btn btn-primary px-3">Join Now</a>\r
                        </div>\r
                    </div>\r
                    <div class="col-12 col-lg-4">\r
                        <div class="overflow-hidden mb-5">\r
                ...
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.3s">\r
                    <div class="col-3 col-lg-2 pe-0">\r
                        <div class="text-center border-bottom border-dark py-3 px-2">\r
                            <h6>01 Jan 2045</h6>\r
                            <p class="mb-0">Wed 11:30</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-9 col-lg-6 border-start border-dark pb-5">\r
                        <div class="ms-3">\r
                            <h4 class="mb-3">Eid Ul Fitr</h4>\r
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut \r
                                aliquip ex ea commodo consequat. Duis aute irure dolor in </p>\r
                            <a href="#" class="btn btn-primary px-3">Join Now</a>\r
                        </div>\r
                ...
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.5s">\r
                    <div class="col-3 col-lg-2 pe-0">\r
                        <div class="text-center border-bottom border-dark py-3 px-2">\r
                            <h6>01 Jan 2045</h6>\r
                            <p class="mb-0">Thu 11:30</p>\r
                        </div>\r
                    </div>\r
                    <div class="col-9 col-lg-6 border-start border-dark pb-5">\r
                        <div class="ms-3">\r
                            <h4 class="mb-3">Eud Ul Azha</h4>\r
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut \r
                                aliquip ex ea commodo consequat. Duis aute irure dolor in </p>\r
                            <a href="#" class="btn btn-primary px-3">Join Now</a>\r
                        </div>\r
...
\r
        <!-- Footer Start -->\r
        <div class="container-fluid footer pt-5 wow fadeIn" data-wow-delay="0.1s">\r
            <div class="container py-5">\r
                <div class="row py-5">\r
                    <div class="col-lg-7">\r
                        <h1 class="text-light mb-0">Subscribe our newsletter</h1>\r
                        <p class="text-secondary">Get the latest news and other tips</p>\r
                    </div>\r
                    <div class="col-lg-5">\r
                        <div class="position-relative mx-auto">\r
                            <input class="form-control border-0 w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email">\r
                            <button type="button" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">Subcribe</button>\r
                        </div>\r
                    </div>\r
                    <div class="col-12">\r
                        <div class="border-top border-secondary"></div>\r
                    </div>\r
                </div>\r
                <div class="row g-4 footer-inner">\r
                    <div class="col-md-6 col-lg-6 col-xl-3">\r
                        <div class="footer-item mt-5">\r
                            <h4 class="text-light mb-4">THE<span class="text-primary">Mosque</span></h4>\r
                            <p class="mb-4 text-secondary">Nostrud exertation ullamco labor nisi aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</p>\r
                            <a href="" class="btn btn-primary py-2 px-4">Donate Now</a>\r
                        </div>\r
                    </div>\r
                    <div class="col-md-6 col-lg-6 col-xl-3">\r
                        <div class="footer-item mt-5">\r
                            <h4 class="text-light mb-4">Our Mosque</h4>\r
                            <div class="d-flex flex-column">\r
                                <h6 class="text-secondary mb-0">Our Address</h6>\r
                                <div class="d-flex align-items-center border-bottom py-4">\r
                                    <span class="flex-shrink-0 btn-square bg-primary me-3 p-4"><i class="fa fa-map-marker-alt text-dark"></i></span>\r
                                    <a href="" class="text-body">71 Fleetview Dr, Halifax, NS</a>\r
                                </div>\r
                                <h6 class="text-secondary mt-4 mb-0">Our Mobile</h6>\r
                                <div class="d-flex align-items-center py-4">\r
                                    <span class="flex-shrink-0 btn-square bg-primary me-3 p-4"><i class="fa fa-phone-alt text-dark"></i></span>\r
                                    <a href="" class="text-body">+1 902 579 6177</a>\r
                                </div>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-md-6 col-lg-6 col-xl-3">\r
                        <div class="footer-item mt-5">\r
                            <h4 class="text-light mb-4">Explore Link</h4>\r
                            <div class="d-flex flex-column align-items-start">\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Home</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>About Us</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Our Features</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Contact us</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Our Blog</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Our Events</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Donations</a>\r
                                <a class="text-body mb-2" href=""><i class="fa fa-check text-primary me-2"></i>Sermons</a>\r
                            </div>\r
                        </div>\r
                    </div>\r
                    <div class="col-md-6 col-lg-6 col-xl-3">\r
                        <div class="footer-item mt-5">\r
                            <h4 class="text-light mb-4">Latest Post</h4>\r
                            <div class="d-flex border-bottom border-secondary py-4">\r
                                <img src="img/blog-mini-1.jpg" class="img-fluid flex-shrink-0" alt="">\r
                                <div class="ps-3">\r
                                    <p class="mb-0 text-muted">01 Jan 2045</p>\r
                                    <a href="" class="text-body">Lorem ipsum dolor sit amet elit eros vel</a>\r
                                </div>\r
                            </div>\r
                            <div class="d-flex py-4">\r
                                <img src="img/blog-mini-2.jpg" class="img-fluid flex-shrink-0" alt="">\r
                                <div class="ps-3">\r
                                    <p class="mb-0 text-muted">01 Jan 2045</p>\r
                                    <a href="" class="text-body">Lorem ipsum dolor sit amet elit eros vel</a>\r
                                </div>\r
            ...
            <div class="container py-4">\r
                <div class="border-top border-secondary pb-4"></div>\r
                <div class="row">\r
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">\r
                        &copy; <a class="border-bottom" href="#">Your Site Name</a>, All Right Reserved.\r
                    </div>\r
                    <div class="col-md-6 text-center text-md-end">\r
                        <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->\r
                        <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->\r
                        <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->\r
                        Designed By <a class="border-bottom" href="https://htmlcodex.com">HTML Codex</a>\r
                    </div>\r
                </div>\r
            </div>\r
        </div>\r
...
`,keyName:`activity`},{path:`/woman`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/event" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Woman</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Woman</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
`,keyName:`woman`},{path:`/youth`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/sermon" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Youth</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Youth</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
`,keyName:`youth`},{path:`/blog`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/blog" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Latest Blog</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Latest Blog</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
`,keyName:`blog`},{path:`/gallery`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/team" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Gallery</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Gallery</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
`,keyName:`gallery`},{path:`/testimonial`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/testimonial" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Testiminial</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Testiminial</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
`,keyName:`testimonial`},{path:`/contact`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/contact" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">Contact</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">Contact</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
        <!-- Contact Start -->\r
        <div class="container-fluid contact py-5">\r
            <div class="container py-5">\r
                <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">\r
                    <p class="fs-5 text-uppercase text-primary">Get In Touch</p>\r
                    <h1 class="display-3">Contact For Any Queries</h1>\r
                    <p class="mb-0">We welcome your questions, suggestions, and requests. Whether you are seeking information about prayer times, community programs, or services, please contact us using the form below. We look forward to hearing from you.</p>\r
                </div>\r
                <div class="row g-4 wow fadeIn" data-wow-delay="0.3s">\r
                    <div class="col-sm-6">\r
                        <input type="text" class="form-control bg-transparent p-3" placeholder="Your Name">\r
                    </div>\r
                    <div class="col-sm-6">\r
                        <input type="email" class="form-control bg-transparent p-3" placeholder="Your Email">\r
                    </div>\r
                    <div class="col-12">\r
                        <input type="text" class="form-control bg-transparent p-3" placeholder="Subject">\r
                    </div>\r
                    <div class="col-12">\r
                        <textarea class="w-100 form-control bg-transparent p-3" rows="6" cols="10" placeholder="Your Message"></textarea>\r
                    </div>\r
                    <div class="col-12 text-center">\r
                        <button class="btn btn-primary border-0 py-3 px-5" type="button">Send Message</button>\r
                    </div>\r
                </div>\r
            </div>\r
        </div>\r
...
`,keyName:`contact`},{path:`/404`,html:`<!DOCTYPE html>\r
<html lang="en">\r
\r
    <head>\r
        <meta charset="utf-8">\r
...
\r
        <script>\r
            window.location.replace("/404" + window.location.search + window.location.hash);\r
        <\/script>\r
\r
\r
        <!-- Hero Start -->\r
        <div class="container-fluid hero-header">\r
            <div class="container">\r
                <div class="row">\r
                    <div class="col-lg-7">\r
                        <div class="hero-header-inner animated zoomIn">\r
                            <h1 class="display-1 text-dark">404 Error</h1>\r
                            <ol class="breadcrumb mb-0">\r
                                <li class="breadcrumb-item"><a href="#">Home</a></li>\r
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>\r
                                <li class="breadcrumb-item text-dark" aria-current="page">404 Error</li>\r
                            </ol>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
        <!-- 404 Start -->\r
        <div class="container-fluid py-5 wow fadeIn" data-wow-delay="0.1s">\r
            <div class="container text-center py-5">\r
                <div class="row justify-content-center">\r
                    <div class="col-lg-6">\r
                        ...
                        <a class="btn btn-primary py-3 px-4" href="">Go Back To Home</a>\r
                    </div>\r
                </div>\r
            </div>\r
        </div>\r
...
`,keyName:`404`}];function mr(){return(0,M.jsx)(Vt,{children:(0,M.jsxs)(zt,{element:(0,M.jsx)(tr,{}),children:[pr.map(e=>(0,M.jsx)(zt,{path:e.path,element:(0,M.jsx)(fr,{html:e.html,isHome:e.keyName===`index`})},e.path)),(0,M.jsx)(zt,{path:`*`,element:(0,M.jsx)(Lt,{to:`/404`,replace:!0})})]})})}Zn.createRoot(document.getElementById(`root`)).render((0,M.jsx)(x.StrictMode,{children:(0,M.jsx)(kn,{children:(0,M.jsx)(mr,{})})}));